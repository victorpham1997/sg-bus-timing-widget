package com.xsteinlab.sgbustimingwidget.utils;

import android.os.Environment;
import android.util.Log;

import com.xsteinlab.sgbustimingwidget.BuildConfig;
...
public class Utils {
    ...
    public static String FormatTimeDiff(SimpleDateFormat format, String timeString, Long currentTime){
        try{
            ...
            localLogging("Error: " + timeString.length());
            e.printStackTrace();
            return "?";
        }
        return "";
    ...
    public static void localLogging(String tag, String log){
        if(BuildConfig.DEBUG){
            Log.i(tag, log);
        }
    }

    public static void localLogging(String log){
        if(BuildConfig.DEBUG){
            String tag = "MyApp";
            Log.i(tag, log);
        }
...
//        Function to log to file for ease of debugging, not needed for release
//        localLogging("MyApp", msg);
